namespace SharpMongo.Core.Tests
{
    ...
    public class DynamicObjectTests
    {
        ...
        [TestMethod]
        public void NoMatchOneGreaterThanQueryUsingExpression()
        {
            DynamicObject document = new DynamicObject("Name", "Adam", "Age", 800);
            DynamicObject query = new DynamicObject("Age", new DynamicObject("$gt", new DynamicObject("$multiply", new object[] { 500, 2})));
        ...
        [TestMethod]
        public void MatchOneGreaterOrEqualThanQueryUsingExpression()
        {
            DynamicObject document = new DynamicObject("Name", "Adam", "Age", 800);
            DynamicObject query = new DynamicObject("Age", new DynamicObject("$gte", new DynamicObject("$add", new object[] { 400, 400 })));
        ...
        [TestMethod]
        public void MatchNotEqualQueryUsingExpression()
        {
            DynamicObject document = new DynamicObject("Name", "Adam", "Age", 800);
            DynamicObject query = new DynamicObject("Age", new DynamicObject("$ne", new DynamicObject("$add", new object[] { 300, 400 })));
        ...
        [TestMethod]
        public void NoMatchNotEqualQueryUsingExpression()
        {
            DynamicObject document = new DynamicObject("Name", "Adam", "Age", 800);
            DynamicObject query = new DynamicObject("Age", new DynamicObject("$ne", new DynamicObject("$add", new object[] { 400, 400 })));
        ...
        [TestMethod]
        public void MatchEqualQueryUsingExpression()
        {
            DynamicObject document = new DynamicObject("Name", "Adam", "Age", 800);
            DynamicObject query = new DynamicObject("Age", new DynamicObject("$eq", new DynamicObject("$add", new object[] { 400, 400 })));

            Assert.IsTrue(query.Match(document));
        }

        [TestMethod]
        public void NoMatchEqualQueryUsingExpression()
        {
            DynamicObject document = new DynamicObject("Name", "Adam", "Age", 800);
            DynamicObject query = new DynamicObject("Age", new DynamicObject("$eq", new DynamicObject("$add", new object[] { 400, 300 })));
